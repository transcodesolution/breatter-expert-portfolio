                                ...
                                <div className="footer_menu_block">
                                    <h3 className="footer_title">service</h3>
                                        <ul className="footer_menu">
                                            <li><NavLink to="/Profilepage">Home</NavLink></li>
                                            <li><NavLink to="/Historypage">About Us</NavLink></li>
                                            <li><NavLink to="/ChatUspage">Service</NavLink></li>
                                            <li><NavLink to="/Walletpage">Blog</NavLink></li>
                                            <li><NavLink to="/ContactUs1page">Contact us</NavLink></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                    <div className="footer_menu_block">
                                        ...
                                        <ul className="footer_menu">
                                            ...
                                            <li><NavLink to="/AddExplanationpage">Solutions</NavLink></li>
                                            <li><NavLink to="/DocUploadpage">Service</NavLink> </li>
                                            <li><NavLink to="/StudentQuestionpage">Terms & Condition</NavLink></li>
